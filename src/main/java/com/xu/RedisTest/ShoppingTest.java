...
public class ShoppingTest {
    ...
    public void testLoginCookies(Jedis conn)
        throws InterruptedException
    {
        System.out.println("**************************** 测试登录的cookies开始******************************-----");
        String token = UUID.randomUUID().toString();
        String num = DateUtil.getFormat(new Date());
        updateToken(conn, token, "xuguoqiang"+num, "productXXX");
        System.out.println("我们只是更新令牌 token: " + token);
        System.out.println("For user: 'xuguoqiang'"+num);
        System.out.println();
        conn.set("username", "xuguoqiang"+num);
        System.out.println(conn.get("username"));
        ...
        extends Thread
    {
        ...
        public CleanSessionsThread(int limit) {
            this.conn = new Jedis("192.168.130.5");
            this.conn.select(15);
            this.limit = limit;
        }
        ...
        extends Thread
    {
        ...
        public CleanFullSessionsThread(int limit) {
            this.conn = new Jedis("192.168.5.130");
            this.conn.select(15);
            this.limit = limit;
        }
